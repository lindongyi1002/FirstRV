...
gui_set_pref_value -key app_default_font -value {Bitstream Charter,18,-1,5,50,0,0,0,0,0}
...
gui_load_child_values {ALU32_tb}
...
gui_sg_addsignal -group "$_session_group_1" { ALU32_tb.Zero ALU32_tb.ALUOut ALU32_tb.in0 ALU32_tb.in1 ALU32_tb.ALUCtrl }
...
catch {gui_list_select -id ${Hier.1} {ALU32_tb}}
...
gui_list_show_data -id ${Data.1} {ALU32_tb}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {ALU32_tb.Zero ALU32_tb.ALUOut ALU32_tb.in0 ALU32_tb.in1 ALU32_tb.ALUCtrl }}
